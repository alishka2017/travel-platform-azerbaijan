...
export function generateMetadata({ params }: { params: { id: string } }): Metadata {
  return generateRestaurantMetadata(params.id);
}

export default function RestaurantDetailPage({ params }: { params: { id: string } }) {
  const restaurant = places.find(p => p.id === params.id && p.category === 'Restaurants');
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <span>/</span>
            <Link href="/restaurants" className="hover:text-[#00AA6C]">Restaurants</Link>
            <span>/</span>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="flex items-center gap-1">
                ...
                <span className="text-gray-500">({restaurant.reviewsCount.toLocaleString()} reviews)</span>
              </div>
