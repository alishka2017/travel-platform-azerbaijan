              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white">+994 70 216 66 66</p>
                    <p className="text-gray-400">+994 12 493 62 42, +994 12 493 62 52</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-4 h-4 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="text-white">info@smartholiday.az</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white">Nizami str. 100, Baku, Azerbaijan AZ1026</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="border-t border-gray-800 mt-16 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              © {new Date().getFullYear()} Smartholiday.az. All rights reserved.
            </p>
